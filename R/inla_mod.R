formula1 <- N_deaths ~  1 + #intercept
  t +   #fixed effect for time
  # pandemic_period + #fixed effect for pandemic
  f(agey,model = "ar1")+  #age-specific intercept
  f(agey2,t,model = "ar1") +   #age-varying effect for time
  f(agey3,pandemic_period,model = "ar1")+  #age-varying effect for pandemic
  log.offset
