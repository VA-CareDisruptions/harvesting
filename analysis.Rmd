...
life_table <- cbind.data.frame('prob_death_cond'=annual_prob_death) %>% #prob of dying in this year conditional on having suvived
  mutate(agey=0:100,
         ...
         prob_death_uncond= prob_death_cond*cum_prob_surv,
         prob_death_uncond= prob_death_uncond/sum(prob_death_uncond)) #unconditional probability of dying at this age
