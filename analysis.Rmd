...
params<-c('lambda', 'beta','delta','rho','tau.beta','int')
##############################################
#Posterior Sampling
##############################################
...
ggplot(post_beta, aes(x=index_n, y=(post_means))) +
  theme_classic() +
  geom_ribbon(aes(x=index_n, ymin=(`1`), ymax=(`2`)),fill='gray80') +
  geom_line()+
  ggtitle('Log-Mortality ratio by Age') +
    xlab('Age (years)')


ggplot(post_delta, aes(x=index_n, y=(post_means))) +
  theme_classic() +
  geom_ribbon(aes(x=index_n, ymin=(`1`), ymax=(`2`)),fill='gray80') +
  geom_line()+
  ggtitle('Log-Pandemic effect ratio by Age') +
    xlab('Age (years)') +
  ylab('log-Pandemic effect')
