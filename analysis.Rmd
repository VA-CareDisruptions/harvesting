...
trouble with epislon an dbeta corr
```{r}
...
(p1.age.jags+ggtitle('JAGS') + ylim(-8,6)) + (p1.age.inla+ggtitle('INLA')+ ylim(-8,6))

#NOTE DIFFERENT SCALE HERE
(p2.time.age.jags+ggtitle('JAGS') +ylim(0.1,50)) + (p2.time.age.inla+ggtitle('INLA')+ylim(0.98,1.03))
